    ...
    <section class="py-24 bg-[#0F172A] relative overflow-hidden" id="team">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-20 sm:space-y-24">
            @php
                ...
                $engineers = $team->where('is_founder', false);

                // Staggered up-down wave rhythm matching the visual reference photo
                $staggerOffsets = [
                    'lg:mt-0 sm:mt-0',
                    'lg:mt-14 sm:mt-8',
                    'lg:mt-3 sm:mt-0',
            ...
            <div class="space-y-10 sm:space-y-12">
                ...
                <!-- Executive Grid (Founder, CEO, CMO, CTO - Staggered Up/Down) -->
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-6 lg:gap-7 items-start">
                    @foreach($executives as $index => $founder)
                        <!-- @php
                                    ...
                                    $offset = $staggerOffsets[$index % count($staggerOffsets)];
                                @endphp -->

                        <article class="group {{ $offset }} reveal" data-delay="{{ $index * 110 }}">
                            <div
            ...
            @if($engineers->isNotEmpty())
                ...
                <div class="space-y-10 sm:space-y-12 pt-6">
                    ...
                    <!-- Engineering Grid (Staggered Up/Down) -->
                    <div
                        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-6 lg:gap-7 items-start">
